...
El perfil base incluye la plantilla canónica completa de \`## PATRONES VIVOS\` con todas sus cabeceras; preservalas aunque alguna subsección todavía esté vacía.
</adaptacion-documental>

<input>
Recibís un prompt de tarea con el perfil actual completo, evidencia de corrección de la sesión, evidencia positiva y metadata determinística como presión por conteo de palabras.
</input>

<contrato>
Ejecutá únicamente el protocolo activado por el prompt de la tarea.
Tratā el markdown actual como un documento a preservar con patch conservador, aunque la salida final del caller deba ser el markdown completo actualizado.
Devolvé SOLO el output estructurado solicitado por el caller.
</contrato>

<respuesta-final>
Confirmá de manera resumida qué cambios específicos lograste incorporar al perfil documental desde las sugerencias y patrones limpios, indicando agregados, podas o transiciones logradas.
</respuesta-final>`;
